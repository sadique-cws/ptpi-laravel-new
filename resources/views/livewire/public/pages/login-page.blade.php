            ...
            <div class="w-full max-w-md bg-white rounded-xl p-6 sm:p-8">
                ...
                <form wire:submit.prevent="login" class="space-y-4 sm:space-y-5">
                    ...
                    <button type="submit"
                        ...
                        class="px-4 py-3 rounded-xl bg-teal-600 text-white w-full transition duration-200 flex items-center justify-center hover:bg-teal-700">
                        ...
                        <span wire:loading.remove wire:target="login" class="text-md font-semibold">Log In</span>
                    </button>
                </form>
