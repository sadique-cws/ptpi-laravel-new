                    ...
                    <div class="mt-3">
                        ...
                        <form wire:submit.prevent="storeOrUpdate" class="space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <!-- Subject - Updated disabled logic -->
                                <div>
                                    <label for="subject" class="block text-sm font-medium text-gray-700 mb-1">Subject</label>
                                    <select wire:model.live="subject" id="subject" 
                                        class="w-full p-2 border rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                    ...
                                    @if(!$category_id)
                                        <p class="mt-1 text-xs text-gray-500">Please select a category first</p>
                                    @endif
